...
1. On the **Address** FastTab on a card page, enter a postal code and then choose the **Look up address from postcode** action.
   ...
   > [!NOTE]
   > The **Look up address from postcode** action is only available if the **Country/Region Code** field is either empty, or contains **GB**, **UK**, **NL**, **SG**, or **IE**.

1. On the **Address Selection** page, choose the address.

   The address-related fields on the card page fill in with the data from the chosen address.
